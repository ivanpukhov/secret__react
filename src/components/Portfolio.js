...
function Portfolio() {
    ...
    const handleWithdraw = async (id) => {
        try {
            const response = await axios.post(`http://localhost:3001/api/portfolios/bundles/${id}/withdraw-income`, {}, {withCredentials: true});
    ...
    const handleSell = async (id) => {
        try {
            const response = await axios.post(`http://localhost:3001/api/portfolios/bundles/${id}/sell`, {}, {withCredentials: true});
